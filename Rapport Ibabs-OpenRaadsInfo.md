...
maar ook bijvoorbeeld besluitenlijsten en zo zijn er nog veel meer soorten documenten die hier onder vallen. Deze documenten worden over het algemeen verzameld op het bestuurslijke informatie deel van de website van de organisatie. Dit bestuurlijke informatiedeel is soms een eigen implementatie van de organisatie zelf, maar veel vaker wordt dit deel uitbesteed aan een andere organisatie en wat volgt is een vergelijkbaar standaardmodel dat meerdere organisaties hebben. In dit geval gaat het dan over de iBabs en NotuBiz modellen.  
...
gedaan tijdens deze periode en zal dus ook voor een groot deel zijn waar mijn verslag overgaat. Omdat de iBabs en NotuBiz standaardmodellen zijn en dus praktisch vergelijkbaar zijn voor iedere organisatie die hierbij is aangesloten is het voor de meeste gemeenten die hierop aangesloten zijn mogelijk om bestuurlijke informatie te halen uit de API. 
